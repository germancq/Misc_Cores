...
set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports {addr[1]}]
set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports {addr[2]}]
set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports {addr[3]}]
...
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports {we}]
...
#set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports {o_bit}]
